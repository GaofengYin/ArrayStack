...
public class Tp2_36233_36232 {
     ...
     * Este metodo cria um arraystack que guarda os '(','{'e'['.Com ciclo for percorrermos o string e ao encontrar o carater '(' ou '{' ou '[' faz o stack.push(inic).
    ...
    public static void main(String[] args) {
        ...
        //Array de string onde se vai verificar se ha integridade
        ...
        //ciclo for para percorrer o array de string e verifica se ha integridade
